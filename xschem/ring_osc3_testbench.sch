...
digital=0
sim_type=spectrum
rawfile=$netlist_dir/ring_osc3_testbench_fft.raw}
...
logy=0
digital=0}
C {ring_osc3.sym} 170 160 0 0 {name=x1}
...
C {sky130_fd_pr/corner.sym} -310 -145 0 0 {name=CORNER only_toplevel=true corner=fs}
...
.control
  ...
  foreach v 1.0 1.2 1.4 1.6 1.8
    ...
    tran 10p 500n 100n
    remzerovec
    write ring_osc3_testbench.raw

    linearize
    fft v(out) v(out_parax)

    write ring_osc3_testbench_fft.raw
    set appendwrite
  end
...
C {ring_osc3.sym} 430 160 0 0 {name=x2
schematic=ring_osc3_parax.sim
spice_sym_def="tcleval(.include [file normalize ../mag/ring_osc3.sim.spice])"
tclcommand="textwindow [file normalize ../mag/ring_osc3.sim.spice]"
}
