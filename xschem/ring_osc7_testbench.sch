...
digital=0
sim_type=spectrum
rawfile=$netlist_dir/ring_osc7_testbench_fft.raw}
...
logy=0
digital=0}
C {ring_osc7.sym} 170 160 0 0 {name=x1}
...
.control
  ...
  foreach v 1.0 1.2 1.4 1.6 1.8
    ...
    tran 10p 500n 100n
    remzerovec
    write ring_osc7_testbench.raw

    linearize
    fft v(out) v(out_parax)

    write ring_osc7_testbench_fft.raw
    set appendwrite
  end
...
schematic=ring_osc5_parax.sim
spice_sym_def="tcleval(.include [file normalize ../mag/ring_osc5.sim.spice])"
tclcommand="textwindow [file normalize ../mag/ring_osc5.sim.spice]"
}
